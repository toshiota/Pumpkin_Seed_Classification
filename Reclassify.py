...
#for i in range(1000):
    ...
    img = img_to_array(load_img(images[i], color_mode='rgb', target_size = (128,128)))    #処理用画像  , interpolation = 'nearest'
    X = []
    X.append(img)
